...
Consider adding the needed paths to the "robot.pythonpath" setting and calling the "Robot Framework: Clear caches and restart" action.
...
It says AppiumLibrary (rf bindings) cannot import TouchAction from appium itself.

So, next we need to check what Appium-Python-Client is used, pip3 list displays version 4.0.0.
...
Successfully uninstalled Appium-Python-Client-4.0.0
Successfully installed Appium-Python-Client-3.2.1
...
marcelomenon@FFPTMFG40P0Q05Q ~ % pip3 install pyyaml
Collecting pyyaml
...
Downloading PyYAML-6.0.1-cp312-cp312-macosx_11_0_arm64.whl (165 kB)
   ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ 165.6/165.6 kB 4.9 MB/s eta 0:00:00
...
- How to get the .app path in the XCode
...
https://www.youtube.com/watch?v=og0Oz0_lStM
...
https://www.youtube.com/watch?v=9Dl2Hfl6Dhg
...
https://www.youtube.com/watch?v=ZV47LblOeYA&list=PLL34mf651faORDOyJrk0E6k9FM-wKgfPV&index=5
